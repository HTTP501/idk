    ...
    <View style={styles.container}>
      ...
      <View style={styles.box}>
        <View className='flex-row items-center'>
          <Checkbox color={theme['sky-basic']} style={styles.checkbox} value={isProductDescriptionChecked} onValueChange={setProductDescriptionChecked} />
      ...
      <View style={styles.box}>
        <View className='flex-row items-center'>
          <Checkbox color={theme['sky-basic']} style={styles.checkbox} value={isAgreementAllChecked} onValueChange={setAgreementAllChecked} />
      ...
      <View style={styles.notbox}>
        <Checkbox color={theme['sky-basic']} style={styles.checkbox} value={isDepositInsuranceInfoChecked} onValueChange={setDepositInsuranceInfoChecked} />
        <Text className='text-sm w-72'>본인은 IDK은행으로부터 예금자보호제도에 대한 보험관계 및 보험금 한도에 대하여 안내 내용을 제공받고 이해하였음을 확인합니다.</Text>
      </View>
      <View style={styles.notbox}>
        <Checkbox color={theme['sky-basic']} style={styles.checkbox} value={isProductDescriptionConfirmationChecked} onValueChange={setProductDescriptionConfirmationChecked} />
