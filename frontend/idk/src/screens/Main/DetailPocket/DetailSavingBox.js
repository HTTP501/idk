...
import { getPiggyBankDetailAxios, deletePiggyBankAxios } from '../../../API/Saving'
          ...
          <View style={styles.back}>
            ...
            <View style={styles.info}>
              ...
              <View className='flex-row justify-around my-6'>
                <TouchableOpacity
                  style={styles.button}
                  onPress={() => {navigation.navigate('MinusSavingBox', {change: true, pocketId, balance})}}
                >
                  <Text className='text-base'>+ 넣기</Text>
                </TouchableOpacity>
                <TouchableOpacity
                  style={styles.button}
                  onPress={() => {navigation.navigate('MinusSavingBox', {change: false, pocketId, balance})}}
                >
